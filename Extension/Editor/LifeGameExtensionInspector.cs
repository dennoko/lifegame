...
namespace lilToon
{
    public class LifeGameExtensionInspector : lilToonInspector
    {
        // Custom properties
        //MaterialProperty customVariable;

        private static bool isShowCustomProperties;
        private const string shaderName = "LifeGameExtension";
        ...
        /*
        [MenuItem("Assets/LifeGameExtension/Convert material to custom shader", false, 1100)]
        private static void ConvertMaterialToCustomShaderMenu()
        {
            if(Selection.objects.Length == 0) return;
            LifeGameExtensionInspector inspector = new LifeGameExtensionInspector();
